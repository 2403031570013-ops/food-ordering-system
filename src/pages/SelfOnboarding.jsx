...
export default function SelfOnboarding() {
    ...
    return (
        <div className="min-h-screen pt-20 pb-20 px-4 bg-gradient-to-br from-orange-50 to-slate-100">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-100 rounded-full mb-4">
                        ...
                        <span className="text-orange-600 font-semibold">Partner Registration</span>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
                    ...
                    >
                        ...
                        <h3 className="font-bold text-slate-900 mb-2">Quick Approval</h3>
                        <p className="text-sm text-slate-600">Get started in 2-3 business days</p>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        <div className="text-3xl mb-2">📈</div>
                        <h3 className="font-bold text-slate-900 mb-2">Grow Your Sales</h3>
                        <p className="text-sm text-slate-600">Reach thousands of customers</p>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        <div className="text-3xl mb-2">💰</div>
                        <h3 className="font-bold text-slate-900 mb-2">Low Commission</h3>
                        <p className="text-sm text-slate-600">Best rates in the industry</p>
                    </motion.div>
                </div>
